...
public class HomeBlockEntities {
    ...
    private static final BlockEntityType<CrucibleBlockEntity> CRUCIBLE_BLOCK_ENTITY = registerBlockEntityType("crucible", FabricBlockEntityTypeBuilder.create(CrucibleBlockEntity::new));
